...
reason_for_skip_on_other_os = "이 테스트는 macOS에서만 실행됩니다."
...
@pytest.mark.skipif(sys.platform != 'darwin', reason=reason_for_skip_on_other_os)
def test_mac_only_functionality():
    """MAC OS 특정 기능을 테스트합니다."""
    print("\n이 코드는 macOS에서만 실행됩니다.")
    assert True
